...
{
    /// <inheritdoc />
    public partial class PremiumLogisticMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemporaryPassword = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccessedBy = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Invalidated = table.Column<bool>(type: "bit", nullable: false),
                    AuctionLocation = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    Auction = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    VIN = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    ...
                    ClientStorage = table.Column<int>(type: "int", nullable: false),
                    ...
                    StorageCost = table.Column<int>(type: "int", nullable: false),
